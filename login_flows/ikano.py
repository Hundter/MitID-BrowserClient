# Script for https://opsparing.ikanobank.dk/login
...
# First part of Ikano procedure
request = session.get('https://opsparing.ikanobank.dk/login')
...
brokerpageurl = 'https://ikanobank.mitid.dk/authorize'
...
# Second part of Ikeano procedure
...
approval_url_script = soup.find('script', string=re.compile("opsparing.ikanobank.dk")).string
